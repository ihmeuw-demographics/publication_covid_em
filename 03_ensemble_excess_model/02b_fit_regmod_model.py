...
Steps:
    ...
    4. Save plots
Inputs:
   * Processed all-cause mortality and population: {main_dir}/inputs/data_all_cause/{ihme_loc_id}.csv
Outputs:
   * {main_dir}/outputs/summaries_regmod/{ihme_loc_id}_age_specifics.csv
   * {main_dir}/outputs/summaries_regmod/{ihme_loc_id}_all_ages.csv
   * {main_dir}/diagnostics/results_regmod/{ihme_loc_id}_age_specifics.pdf
   * {main_dir}/diagnostics/results_regmod/{ihme_loc_id}_all_ages.pdf
"""
