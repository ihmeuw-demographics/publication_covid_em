...
# Inputs:
#   * Data: {main_dir}/inputs/data_all_cause/{ihme_loc_id}.csv
#   * Config: {main_dir}/covid_em_detailed.yml
#   * Meta default: {code_dir}/meta.yaml
# Outputs:
#   * Meta prepped: {main_dir}/inputs/data_all_cause/meta.yaml
