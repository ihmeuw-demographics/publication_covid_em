...
# Outputs:
#   * All-cause mortality data: {main_dir}/inputs/data_all_cause/{ihme_loc_id}.csv
#   * COVID death data: {main_dir}/inputs/data_covid.csv
...
fs::file_copy(
  ...
  fs::path(main_dir, "/inputs/stage1_ensemble_weights.csv"),
  overwrite = TRUE
)
